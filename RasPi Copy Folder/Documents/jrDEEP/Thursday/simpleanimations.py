...
for x in range (50,200,1): #Count from 50 -> 200 by 1s	
	pygame.draw.circle(window,white,(x,y),50,0)#Draw a white circle to the window which is filled
	pygame.display.flip()#display all the drawing
	pygame.time.wait(10)#wait 10ms
	pygame.draw.circle(window,black,(x,y),50,0) #erase the circle by drawing a black circle over it
